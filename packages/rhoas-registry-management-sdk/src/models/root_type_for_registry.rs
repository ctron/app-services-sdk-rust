...
pub struct RootTypeForRegistry {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "status")]
...
impl RootTypeForRegistry {
    /// Service Registry instance within a multi-tenant deployment.
    pub fn new(id: String, status: crate::models::RegistryStatusValue, created_at: String, updated_at: String, instance_type: crate::models::RegistryInstanceTypeValue) -> RootTypeForRegistry {
        RootTypeForRegistry {
            id,
            status,
            registry_url: None,
